...
const { hotRef, hotSettings, tableData, addRow, deleteSelectedRow } = useTableController('box', 'boxes');
...
<template>
  <div class="table-pane-content">
    <div class="info-box" data-i18n-html="ui.info.boxes">
      <strong>Annotation boxes:</strong> set label, detail, and visual placement.
    </div>
