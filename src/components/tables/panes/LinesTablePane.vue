...
const { hotRef, hotSettings, tableData, addRow, deleteSelectedRow } = useTableController('line', 'lines');
...
<template>
  <div class="table-pane-content">
    <div class="info-box" data-i18n-html="ui.info.lines">
      <strong>Reference lines:</strong> use label X for manual offset when needed.
    </div>
