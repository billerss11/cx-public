...
const { hotRef, hotSettings, tableData, addRow, deleteSelectedRow } = useTableController('plug', 'plugs');
...
<template>
  <div class="table-pane-content">
    <div class="info-box" data-i18n-html="ui.info.plugs">
      <strong>Cement plugs:</strong> set top/bottom and optional manual width.
    </div>
